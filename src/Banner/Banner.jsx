...
const Banner = () => {
    return (
        <div className="background mt-5 rounded-xl">
              <div>
              <p className=" pt-32 text-4xl font-bold px-24 text-white text-center">
                Discover An Exeptional Cooking</p>  <p className="text-4xl font-bold px-24 text-white text-center pt-5">  Class Tailord For You
             </p>
             
              </div>
              <p className='text-white px-24 text-center mt-5'> 
